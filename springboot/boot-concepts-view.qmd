...
In Spring Boot, views are t**ypically implemented using template engines such as `Thymeleaf` or `FreeMarker`**.
...
![ThymeLeaf how TH: works (1/2)](/images/springboot/howtagsTHworks.png){width="80%"}

![ThymeLeaf how TH: works (2/2)](/images/springboot/howtagsTHworks2.png){width="80%"}
