...
```html
<td>
     <a th:href ="@{updateBook(bookIdFromView=${book.bookId})}"
                    class="w3-button w3-cyan">Update this book</a>
</td>
```
::: {.column-margin}
![](/images/springboot/createUser-01.png)
...
<form action="#"
    ...
    <p>
        ...
        th:field="*{bookId}" readonly></p>
    <p>
    <p>
        <label for="title">Title</label>
        <input  type="text" name="title" id="title"  th:field="*{title}"></p>
    <p>
        <label for="isbn">ISBN</label>
        <input  type="text" name="isbn" id="isbn"  th:field="*{isbn}"></p>
    <p>
        <label for="pages">Pages</label>
        <input type="number" name="pages" id="pages" th:field="*{pages}" ></p>
