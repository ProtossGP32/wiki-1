...
1. The client sends a ``request`` to server-controller to get the create-user form: [Users template](https://github.com/AlbertProfe/CifoJava2023/blob/dea67f25d24bcc89a6141762d5ed17085660349b/controllerView/src/main/resources/templates/user/users.html#L27){.external}
...
1. The client sends a ``request`` to server-controller to get the update-user form: [Update user template](){.external}
