...
| [Library Management Rest MongoDB 0.1](https://github.com/AlbertProfe/CifoJava2023/tree/ffe874191e40e9f54f81a6e5c883edc581f96f5f/LibraryManagementRest){.external}  | all CRUD operations wiht `bookImage` document  | - | - |
| [Library Management Rest MongoDB 0.2](){.external}  | add ImageBook Id to books List `book` entity  | - | - |
| [Library Management Rest MongoDB 0.3](){.external}  | add data encryptation | - | - |
