...
### Configure H2 database in LibraryManagmentRest:

- `pom.xml`: dependencies H2 and JPA
- `UserRepository` interface
- `User` class @Entity
- `application.properties`
- modify service to create a User and save it to H2 DB



### `application.properties`

- Open the `application.properties` file located in the s`rc/main/resources` directory of your Spring Boot project.
