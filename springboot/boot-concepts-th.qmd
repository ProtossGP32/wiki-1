...
We could add another lenguage by creating a new file named ``messages_fr.properties`` (``messages_cat.properties``, ``messages_es.properties``, ``messages_jap.properties``) in the same directory.
