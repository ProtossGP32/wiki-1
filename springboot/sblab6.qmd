...
Deployed on `Heroku`: <s>[Heroky deploy](https://employeecourse.herokuapp.com/){.external}</s>
...
<br>
[{{< fa solid arrow-left >}} Lab#SB05-1: Advanced strategies](/springboot/sblab5.qmd)
<br>
</div>
<br>
