...
This UML would fit the final version of our project (without the @ManyToMany `Customer 1-n Booking n-1 TableRestaurant` relationship:):
...
With the @ManyToMany `Customer 1-n Booking n-1 TableRestaurant` relationship:
...
### RestaurantManger Relationships
