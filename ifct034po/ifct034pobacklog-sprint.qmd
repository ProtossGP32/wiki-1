...
|  | 10 | 18/10/2023 | - Spring Boot Architecture: **request-response cycle** </br> - Spring Boot Architecture Consumers: </br> 1. server-side render (Thymeleaf), </br> 2. client-side render (React), </br> 3. API Rest  </br>- API Rest Introduction: @RestController  </br> - Postman:intall, create account and docs  | - [javaFaker books demoJavaBook](https://github.com/AlbertProfe/demoJavaBoot/tree/aa30f22cc3c09168a6e1432eebb68246e9be72d3) </br> - [Video first hour class](https://drive.google.com/file/d/1UGwPNHMou4a9KbRXgh_FiIJeFk6cmx-K/view?usp=share_link) </br> ![](/images/ifct034po/photo_2023-10-18_11-05-13.jpg) |
