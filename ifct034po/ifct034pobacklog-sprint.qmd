...
| -- | -- | -- | -- | -- |
| #3 | 8 | 16/10/2023 | - Thymeleaf </br> - Tags attributes TH: text, link, each </br> - Spring Boot create **fake** @Service </br> - Git and Github  </br> ++ Immutability | - [Git](https://albertprofe.dev/devops/devops-vc-git.html) </br> - [GitHub](https://albertprofe.dev/devops/devops-vc-github.html)   |
