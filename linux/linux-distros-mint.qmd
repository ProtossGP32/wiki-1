...
2. ```sudo mv /etc/apt/preferences.d/nosnap.pref ~/Documents/nosnap.backup```
3. ```sudo apt update``` (previous upgrade)
4. ```sudo apt install snapd```
5. **log out** and then **log in**
6. ```snap install hello-world```
  
    hello-world 6.4 from Canonical✓ installed
7. ```hello-world```
  
    Hello World!
8. ```sudo snap install --classic tmcbeans```
