...
1. Go to **C:\Program** **Files\TMCBeans\etc**
...
Para el tmcbeans debes en linux trabajar con jdk8 o jdk11, pero nunca con superiores.

Por lo tanto:

- setea tu sistema a 8:
  - https://askubuntu.com/questions/121654/how-to-set-default-java-version

Sino, es un tema de local path java variables:

- local path variable:
  - https://www.ibm.com/docs/ja/b2b-integrator/6.0.3?topic=variables-setting-java-linux
