...
- [Scrum Glossary](https://www.scrum.org/resources/scrum-glossary){.external}
...
To learn more about the Scrum framework, to identify which of these terms are required elements of Scrum and to understand how the mentioned elements are connected, we highly recommend that you reference the [Scrum Guide™](https://scrumguides.org/){.external}.
...
| Forecast (of functionality) | The selection of items from the Product Backlog Developers deem feasible for implementation in a Sprint.                                                                                                                                                                                                                                                                                                                                             |
| Increment             | Scrum Artifact that defines the complete and valuable work produced by the Developers during a Sprint. The sum of all Increments forms a product.                                                                                                                                                                                                                                                                                                      |
...
<br>
[{{< fa solid arrow-left >}} General Vocabulary](/learning/learning-vocab-general.qmd)
<br>
</div>
<br>
...
<br>
[DevOps Vocabulary  {{< fa solid arrow-right >}}](/learning/learning-vocab-devops.qmd)
<br>
</div>
<br>
</div>
