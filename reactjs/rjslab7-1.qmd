...
-  [traffic lights axios SPA: codesanbox](https://codesandbox.io/p/sandbox/beautiful-sea-9j7tn4?file=%2Fsrc%2FApp.js%3A41%2C5){.external target='_blank'}
...
Whe should [evolve](https://www.dhiwise.com/post/single-page-application-vs-multi-page-application){.external target='_blank'} the project from a SPA to multpage `react-router-dom` site
...
| [GitHub code v0.1](https://github.com/AlbertProfe/trafficlights/tree/f847634752f6109d5575417c8505634451656d6f){.external}  | adding graphics |  |  [render v0.1 render(1)](/images/reactjs/traffic-render-v0.1-1.png), [render v0.1 render(2)](/images/reactjs/traffic-render-v0.1-2.png), [render v0.1 render(3)](/images/reactjs/traffic-render-v0.1-3.png), [render v0.1 render(4)](/images/reactjs/traffic-render-v0.1-4.png),|
