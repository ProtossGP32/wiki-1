...
- implement all CRUD operations with `axios` & `useContext`: [trafficlights SPA 1.4.0](https://codesandbox.io/p/sandbox/trafficslights-v1-3-0-forked-xqj779){.external target='_blank'} 
