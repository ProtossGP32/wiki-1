...
| [GitHub code v0.3](){.external target='_blank'}  | adding react-router-dom, two routes: simulation and mySimlations |  | |
| [GitHub code v0.4](){.external target='_blank'}  | adding data from server: fake & spring boot |  | |
