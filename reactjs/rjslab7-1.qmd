...
| [GitHub code v0.3 `integrationcruddata` ](https://github.com/AlbertProfe/trafficlights/tree/20e9ee5cb695d8e10ba10c3d867081d7c6285fbc){.external target='_blank'}  | adding `react-router-dom`, two routes: `simulation` and `mySimulations` | [branch `mySimulations` ](/images/reactjs/traffic-branches-v0.3-4.png), [project structure](/images/reactjs/traffic-project-v0.3.png) | [render v0.3 render(1)](/images/reactjs/traffic-render-v0.3-1.png){.external target='_blank'}, [render v0.3 render(2)](/images/reactjs/traffic-render-v0.3-2.png){.external target='_blank'}, [render v0.3 render(3)](/images/reactjs/traffic-render-v0.3-3.png){.external target='_blank'},|
| [GitHub code v0.4 `integrationcruddata`](https://github.com/AlbertProfe/trafficlights/tree/bff9bb44cc67536ca3a1c296169c1279bd93d6b9){.external target='_blank'}  |  decoupling `mySimulations`  | - | -  |
| [GitHub code v0.5](){.external target='_blank'}  | adding data from server: mockapi & spring boot |  |   |
