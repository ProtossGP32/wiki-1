...
`const ApiContext = React.createContext();`
Creates a new `context` object called `ApiContext` using the `createContext`, this context object will be used <mark>to share data and functions between components.</mark>
