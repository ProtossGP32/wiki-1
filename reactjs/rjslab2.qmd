...
| Hola5 0.1 | useReducer: user Profile [hola5 0.1](){.external} </br> compoonent useReducer on [codesandbox with handlers functions](https://codesandbox.io/s/usereducer-example-form-nuyyyi?file=/App.js){.external} </br> or [codesandbox dispatcher onChange, onClick](https://codesandbox.io/s/usereducer-example-form-v2-pbj3kh?file=/App.js){.external} | [userReducer tree-folder](/images/reactjs/lab-re-2-1.png){width="60%"} | [render reducer](/images/reactjs/lab-re-2-3.png){width="80%"} |
