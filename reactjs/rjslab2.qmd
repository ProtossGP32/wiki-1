...
- [codesandbox](https://codesandbox.io/s/usereducer-example-form-nuyyyi?file=/App.js){.external}
- [React reference manual](https://react.dev/reference/react/useReducer#usage){.external}

### component and route

Create the new component, the route and the link at layout.
...
| Hola5 0.1 | useReducer: user Profile [hola5 0.1](){.external} </br> compoonent useReducer on [codesandbox](https://codesandbox.io/s/usereducer-example-form-nuyyyi?file=/App.js){.external} | [userReducer tree-folder](/images/reactjs/lab-re-2-1.png){width="60%"} | [render reducer](/images/reactjs/lab-re-2-3.png){width="80%"} |
