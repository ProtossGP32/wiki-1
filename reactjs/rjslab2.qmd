...
In this case, it ensures that t**he interval is cleared and any associated callbacks are stopped when the component unmounts or when the `isRunning` value changes to false.**
