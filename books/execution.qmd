...
- Defines who’s going to achieve the strategy. If you don’t get the people process right, you will never fulfill the potential of your business.
- Use leadership messaging to guide the culture, clarify the goals and issues, and to change employees’ attitudes.
- Behaviors are beliefs turned into action, and behaviors deliver the results.
- Focus on how people execute, not merely the outcomes.
- Coach others and help them learn how to execute.
- Hold people accountable and provide constant feedback on progress.
- A big shortcoming is to be backward-looking; focused on evaluating the jobs people are doing today. Instead, focus on whether individuals can handle the jobs of tomorrow.

### Strategy

- Defines where the business wants to go.
- Corporate-level strategy is the vehicle for allocating resources among all of the business units.
- In shaping the plan, involve all of the people who are responsible for the strategic plan’s outcome.
- Set goals based on the organization’s capabilities for delivering results. An astonishing number of strategies fail because leaders don’t make a realistic assessment of whether the organization can execute the plan.
- Set milestones for the progress of the plan (they bring reality to the plan).


### Budgeting/Operations

- The operating plan provides the path for people to execute the plan.
- Set contingency plans to deal with the unexpected.
- Budgets often have little to do with the reality of execution because they’re merely numbers and gaming exercises.
- Debating the assumptions is one of the most critical parts of any operation plan and review.
...
- [BOOK SUMMARY: “EXECUTION. THE DISCIPLINE OF GETTING THINGS DONE.” BY BOSSIDY, CHARAN](https://www.jfdperfsolutions.com/book-summary-execution-the-discipline-of-getting-things-done-by-bossidy-charan/){.external}
