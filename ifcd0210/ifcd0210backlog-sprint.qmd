...
|  | 67 | 29/03 | - API Rest  </br> <s>(1) @EntityResponse </s></br>(2) CRUD: update </br> (3) upate book: generic object, array of fields and stream, filter| [Library Management Rest 0.3](https://github.com/AlbertProfe/CifoJava2023/tree/700854752bbc5d420e968744f2a0a3bfe7db1e47/LibraryManagementRest){.external}  </br> [Lab#SB00-4](/springboot/sblab0-4.qmd) </br> [Library Management Rest 0.4](https://github.com/AlbertProfe/CifoJava2023/tree/b5fcf2a90186f66a58f119dfaf17ee0be0ddb47c/LibraryManagementRest){.external} |
|  | 68 | 30/03 | - NoSQL: what is NoSQL and SQL H2 JPA </br> - MongoDB / dynamoDB | [LibraryManagementRest](){.external} |
