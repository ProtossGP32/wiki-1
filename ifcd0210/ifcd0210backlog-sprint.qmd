...
|  | 93 | 09/05 | - useEffect, useRef, useReducer: </br> (1) hola5.clock </br> (2) cleanup function </br> - useEffect, useRef, useReducer, useContext: </br> (1) to-do: useCase, use story & mockup </br> - async | [Lab#RE03-1](/reactjs/rjslab3.qmd) </br> [async](/reactjs/reactjs-app-async.qmd) |
