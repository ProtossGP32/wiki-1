...
| -- | -- | -- | -- | -- |
| #21 | 97 | 15/05 | - axios, fetch </br> (1) api rest mockapi </br> - useRef, useReducer, useContext: </br>  (1) to-do: context API </br> | [codesandbox api rest todo cards](https://6kgxh7.csb.app/){.external} </br>  [deployed api rest todo cards](https://6kgxh7.csb.app/){.external} </br> [mock api](https://mockapi.io/){.external} </br> [Lab#RE02-3](/reactjs/rjslab3-2.qmd) |
|  | 98 | 16/05 | - highcharts: </br> (1) to-do: visualisation data </br> (2) import data json </br>  (3) function calculate </br> - styling | [styling](/reactjs/reactjs-app-styling.qmd) |
