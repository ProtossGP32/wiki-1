...
|  | 85 | 26/04 | - React: </br> (1) intro: userReducer / userEffect  </br> (2) JS ES6 </br> (3) conditional render | [useReducer](/reactjs/reactjs-hook-reducer.qmd) </br> [useEffect](/reactjs/reactjs-hook-effect.qmd) </br> [Conditional Render](/reactjs/reactjs-app-conditional-render.qmd) |
