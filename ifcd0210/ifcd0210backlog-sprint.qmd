...
|  | 104 | 24/05 | - useContext to-do CRUD api rest: </br> (1) domains useContext </br> (2) components </br> - websockets: </br> (1) general approach & use-story </br> <s>(2) mock-up </s> | [Lab#RE03-4](/reactjs/rjslab3-4.qmd) </br> [codesanbox websocket context AWS](https://codesandbox.io/s/mychat-1-ktru2t?file=/src/chat/SocketProvider.js){.external}|
|  | 105 | 25/05 | - local.storage </br> - websockets: </br> (1) general approach & domains </br>(2) mock-up </br> | - |
