...
|  | 56 | 14/03 | - LibraryManagement: </br> (1) Borrow </br>  - LibraryProject: </br>  (1) finish core use-cases </br> (2) finish main UML</br> | - |
|  | 57 | 15/03 | - Git </br> -  Spring Session</br> | [HttpSession with JDBC](https://docs.spring.io/spring-session/reference/samples.html){.external} |
|  | 58 | 16/03 | - Spring Boot Rest </br> - ThymeLeaf: </br> (1) Fragments </br> | - |
