...
|  | 42 | 22/02 | - Spring Boot: </br> (1) Book @Controller  </br> (2) Book @Service </br> (3) Book CRUD </br> (4) HTML Thymeleaf </br> (5) H2 DataBase Local Source and Application.properties</br> - <s>Git</s> </br>  | [Library5 Code](https://github.com/AlbertProfe/cifojava2022-3/tree/master/library5){.external} </br> [Library5 Docs](https://github.com/AlbertProfe/cifojava2022-3/wiki/Library5:-ThymeLeaf-Web-Project){.external} </br> [Create H2 DB Spring Boot](/springboot/boot-what-create-th-h2.qmd)|
|  | 43 | 23/02 | - LibraryProject: </br>  (1) finish core use-cases </br> (2) finish main UML</br> | - |
|  | 44 | 24/02 |  - Spring Boot: </br> (1) Thymeleaf </br>  - SCRUM: </br> (1) Motivation/Purpose 2 </br> (2) Burn Out multitasking, several hats </br>  (3) spaceX beyond Scrum | - |
