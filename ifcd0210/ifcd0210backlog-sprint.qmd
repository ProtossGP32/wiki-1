...
|  | 47 | 01/03 | + View-Controller </br> (1) @Service </br>(2) HashMap fake @Repository </br>(3) <b>request-response scope</b>  </br>  (4) redirect: </br>  (5) messages.properties </br>  (6)  CRUD operations draft and pseudo-code </br><s>LibraryProject: </br>  (1) finish core use-cases </br> (2) finish main UML</s></br> | [controllerView Project](https://github.com/AlbertProfe/CifoJava2023/tree/e17d40231644aca79c90ff9205f323536495d8d4/controllerView){.external} </br> [render controllerView](/images/springboot/th_controller_view.png) |
|  | 48 | 02/03 | - LibraryManagement: </br> (0) Mock-up user  </br> (1) Tree-Folder: packages  </br> (2) User: @Entity, fake @Repository, @Controller, @Service  </br> (3) Thymelaf </br>  - LibraryManagement: </br> (1) User & Author </br> - Spring Timeline </br> | [Lab#SB00-2](/springboot/sblab0-2.qmd) </br> |
