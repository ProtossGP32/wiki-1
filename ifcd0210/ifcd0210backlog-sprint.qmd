...
|  | 52 | 08/03 | - controllerView: </br> (1) CRUD: update User </br> (2) CRUD: delete User</br>  |  [CRUD: update](/springboot/sblab0-2.qmd#crud-update) </br> [userController: create](){.external} </br> [CRUD: delete](/springboot/sblab0-2.qmd#crud-delete) </br> [userController: delete](){.external} </br> |
|  | 53 | 09/03 | - LibraryManagement: </br> (1) Borrow </br> - Git </br>  - LibraryProject: </br>  (1) finish core use-cases </br> (2) finish main UML</br> - LibraryManagement: </br> (1) refactor variables and packages </br> (2) Project > Management </br> (3) userController > Management | - |
