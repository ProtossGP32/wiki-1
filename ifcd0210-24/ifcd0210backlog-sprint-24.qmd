...
|  | 7 | 12/01/2024 | - UML: restaurant | - [UML](/javase/se-pattern-uml.qmd) </br> - [UML exemples](https://drive.google.com/drive/folders/1l5kCv2TkFey-SsKjrFBiMtFslb0R4xVP?usp=sharing){.external} </br>  - [IBM: An introduction to the Unified Modeling Language](https://developer.ibm.com/articles/an-introduction-to-uml/){.external}|
