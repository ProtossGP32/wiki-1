...
|  | 14 | 25/01/2024 | -  React introduction: the render cycle   </br> - React Principles: SPA, COP, Virtual DOM, JSX, Hooks, Route </br> - Install nvm: Node Version Manager & create a React Project   </br>   | - [React JS: Introduction](/reactjs/reactjs-what-principles.qmd) </br> - [React JS: Create a React project](/reactjs/reactjs-what-create.qmd) </br> - [React Components](/reactjs/reactjs-what-components.qmd) </br>  - [Lab#RE06-1](/reactjs/rjslab6-1.qmd) |
|  | 15 | 26/01/2024 | ++ **healthyFood React App**</br> | - [Lab#RE06-1](/reactjs/rjslab6-1.qmd)  |
