...
|  |  |  | - NextJS: server actions | - [next-flix-router](https://github.com/AlbertProfe/next-flix-router/wiki){.external target='_blank'} </br> - [App Router](https://nextjs.org/docs/app){.external target='_blank'} </br> |
