...
|  |
|  | 85 | 13/06/2024 | - Spring Boot Security  </br> - Spring Boot Thymeleaf & HTMX  | - [Spring Boot Demo Security](https://github.com/AlbertProfe/JAVA2020-SpringBoot/tree/main/demoSecurity/src/main/java/com/example/demoSecurity){.external target='_blank'} </br>  - [HTMX](https://htmx.org/){.external target='_blank'} </br></br><mark> [Screen video: Thursday-1]({{< meta baseurlaws >}}CifjoJava-2024-06-12-1.mp4){.external target='_blank'}<mark>  </br><mark> [Screen video: Thursday-2]({{< meta baseurlaws >}}CifjoJava-2024-06-12-2.mp4){.external target='_blank'}<mark>  |
