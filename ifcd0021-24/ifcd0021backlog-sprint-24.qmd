...
|   | 18 | 04/10/2024 | - Lab#SB08-1 Spring Boot **RestaurantManager**: </br>  (1) Model Restaurant @Entity </br> (2) CRUD @RestController  </br>  (3) @Service and Interface @ServiceImpl  </br >  ++  Query creation from method names </br> ++ Swagger  </br>-  <s>Git</s> </br> ++ Mardown: document  | - [Lab#SB08-1](/springboot/sblab8-1.qmd){.external target='_blank'} </BR>  - [Spring Boot: Rest](/springboot/boot-concepts-rest.qmd){.external target='_blank'}  </br> - [Query creation from method names](https://docs.spring.io/spring-data/jpa/reference/jpa/query-methods.html){.external target='_blank'} </br> - [Swagger](https://swagger.io/){.external target='_blank'} </br>  - [Redis](https://redis.io/es/){.external target='_blank'} </br> - [Spirng Boot create H2 TH](/springboot/boot-what-create-th-h2.qmd){.external target='_blank'}|
