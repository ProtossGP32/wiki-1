...
|   | 23 | 11/10/2024 | - Lab#SB08-3 Spring Boot **RestaurantManager**: </br> (1) Model @Entitiy Table and Menu </BR>  <s>(2) Inherence: Order</s> </br> (3) .env </br> </br> - Git: `gitTutorial` project </br>  | - [Lab#SB08-3](/springboot/sblab8-3.qmd){.external target='_blank'} </BR>  |
