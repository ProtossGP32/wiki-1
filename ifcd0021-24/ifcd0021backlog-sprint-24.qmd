...
|   | 2 | 10/09/2024 | - Lateralization, how to learn, pareto </br>  - SCRUM fundamentals </br>  - Java Dependencies Management: Maven </br> - POO: methods </br> - GitHub: create repo, commit, push,.. </br> - UML </br> </br> <i> Homework: Pareto examples, Kind of problems? Simple, Complicated, Complex, Kaotic, SCRUM Guide</i>  | - Project </br> - [Maven Create Project](/javase/se-concepts-createproject.qmd){.external target='_blank'}  </br> - [Push to git](/javase/se-concepts-projectgit.qmd){.external target='_blank'}  </br> - [UML Mermaid](https://mermaid.js.org/){.external target='_blank'}|
