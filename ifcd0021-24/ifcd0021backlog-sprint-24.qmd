...
|   | 18 | 04/10/2024 | - Lab#SB08-1 Spring Boot **RestaurantManager**: </br>  (1) Model Restaurant @Entity </br> (2) @Service and CRUD @RestController  </br>  -  <s>Git</s> </br> ++ Mardown: document| - [Lab#SB08-1](/springboot/sblab8-1.qmd){.external target='_blank'} </BR>  - [Spring Boot: Rest](/springboot/boot-concepts-rest.qmd){.external target='_blank'}  |
